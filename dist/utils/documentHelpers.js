 ...
 */
export function normalizeDraftId(documentId) {
 ...
 */
export function normalizeBaseDocId(documentId) {
 ...
 */
function applySetOperations(patch, patchObj) {
 ...
 * @returns Updated patch object
 */
function applyModificationOperations(patch, patchObj) {
    let updatedPatch = patchObj;
 ...
 * @returns Updated patch object
 */
function processBasicOperations(patch, patchObj) {
    let updatedPatch = patchObj;
 ...
 */
function determineInsertSelector(insert) {
    if (insert.at) {
        return insert.at;
    }
 ...
 * @returns Updated patch object
 */
function processInsertOperation(patch, patchObj) {
    let updatedPatch = patchObj;
 ...
 * @returns Updated patch object
 */
function processSpecialOperations(patch, patchObj) {
    let updatedPatch = patchObj;
 ...
 */
export function applyPatchOperations(patch, patchObj) {
 ...
 */
export async function getDocumentContent(client, documentId, fallbackContent) {
 ...
 */
function normalizeStringDocId(documentIds) {
...
//# sourceMappingURL=documentHelpers.js.map