 ...
 */
import type { SanityClient as OriginalSanityClien } from '@sanity/client';
/**
 * Sanity Query Parameters
 */
export interface SanityQueryParams {
    [key: string]: string | number | boolean | string[] | number[] | SanityQueryParams | ((item: unknown) => boolean) | Record<string, unknown> | undefined;
    useCdn?: boolean;
    token?: string;
 ...
 * Content Value type
 */
export type ContentValue = string | number | boolean | SanityReference | Date | null | undefined | ContentObject | ContentArray;
/**
 * Content Object type
 */
