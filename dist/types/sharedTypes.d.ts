...
export type ZodSchemaFromInterface<T> = {
    [K in keyof T]: T[K] extends object ? z.ZodObject<ZodSchemaFromInterface<T[K]>> : T[K] extends Array<infer U> ? z.ZodArray<z.ZodType<U>> : T[K] extends string ? z.ZodString : T[K] extends number ? z.ZodNumber : T[K] extends boolean ? z.ZodBoolean : T[K] extends undefined ? z.ZodUndefined : T[K] extends string | undefined ? z.ZodOptional<z.ZodString> : T[K] extends number | undefined ? z.ZodOptional<z.ZodNumber> : T[K] extends boolean | undefined ? z.ZodOptional<z.ZodBoolean> : T[K] extends Record<string, any> | undefined ? z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>> : z.ZodAny;
};
/**
