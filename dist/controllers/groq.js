 ...
 */
function createClient(projectId, dataset, params = {}) {
 ...
 */
async function executeQuery(client, queryString, params = {}) {
 ...
 */
export async function searchContent(projectId, dataset, queryString, params = {}) {
    try {
 ...
 */
export async function query(projectId, dataset, queryString, params = {}) {
    try {
        // Create client with appropriate configuration
        const client = createClient(projectId, dataset, params);
        // Execute the query
 ...
 */
export async function subscribeToUpdates(projectId, dataset, queryString) {
    try {
 ...
 */
export async function getGroqSpecification() {
    try {
