        ...
        return [
            ...
            },
            {
                ...
                handler: async (args) => {
                    ...
                    return await groqController.searchContent(args.projectId, args.dataset, args.query, args.params || {});
                }
            },
            {
                name: 'query',
                ...
                handler: async (args) => {
                    ...
                    return await groqController.searchContent(args.projectId, dataset, args.query, args.params || {});
                }
            },
            {
                name: 'getDocument',
            ...
            },
            {
                ...
                handler: async (args) => {
                    try {
                        ...
                        return await groqController.searchContent(projectId, dataset, args.query, args.params);
                    }
                    catch (error) {
...
//# sourceMappingURL=groqTools.js.map