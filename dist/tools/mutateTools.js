 ...
 */
export class MutateToolProvider {
    /**
        ...
        return [
            {
                ...
                handler: async (args) => {
                    ...
                    return await mutateController.modifyDocuments(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', mutations, args.returnDocuments || false);
                }
            },
            {
                ...
                handler: async (args) => {
                    return await mutateController.modifyDocuments(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', args.mutations, args.returnDocuments || false);
                }
            },
            {
                name: 'updateDocument',
                ...
                handler: async (args) => {
                    ...
                    return await mutateController.modifyDocuments(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', mutations, args.options?.returnDocuments || false, { visibility: args.options?.visibility });
                }
            },
            {
                name: 'patchDocument',
...
//# sourceMappingURL=mutateTools.js.map