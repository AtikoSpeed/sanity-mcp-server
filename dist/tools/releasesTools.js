 ...
 */
export class ReleasesToolProvider {
    /**
        ...
        return [
            {
                ...
                handler: async (args) => {
                    try {
                        const result = await releasesController.createRelease(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', args.title, args.description);
                        return result;
                    }
                    catch (error) {
            ...
            },
            {
                ...
                handler: async (args) => {
                    try {
                        const result = await releasesController.listReleases(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production');
                        return result;
                    }
                    catch (error) {
            ...
            },
            {
                ...
                handler: async (args) => {
                    try {
                        const result = await releasesController.updateRelease(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', args.releaseId, {
                            title: args.title,
            ...
            },
            {
                ...
                handler: async (args) => {
                    try {
                        const result = await releasesController.archiveRelease(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', args.releaseId);
                        return result;
                    }
                    catch (error) {
            ...
            },
            {
                ...
                handler: async (args) => {
                    try {
                        const result = await releasesController.addDocumentToRelease(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', args.releaseId, args.documentIds);
                        return result;
                    }
                    catch (error) {
...
//# sourceMappingURL=releasesTools.js.map