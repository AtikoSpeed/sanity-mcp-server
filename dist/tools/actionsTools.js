 ...
 */
export class ActionsToolProvider {
    /**
        ...
        return [
            {
                ...
                handler: async (args) => {
                    try {
                        const result = await actionsController.publishDocument(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', args.documentId);
                        return result;
                    }
                    catch (error) {
            ...
            },
            {
                ...
                handler: async (args) => {
                    try {
                        const result = await actionsController.unpublishDocument(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', args.documentId);
                        return result;
                    }
                    catch (error) {
            ...
            },
            {
                ...
                handler: async (args) => {
                    try {
                        const result = await actionsController.deleteDocument(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', [args.documentId]);
                        return result;
                    }
                    catch (error) {
            ...
            },
            {
                ...
                handler: async (args) => {
                    try {
                        const result = await actionsController.unpublishDocumentWithRelease(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', args.releaseId, args.documentId);
                        return result;
                    }
                    catch (error) {
            ...
            },
            {
                ...
                handler: async (args) => {
                    try {
                        ...
                        const result = await actionsController.createDocument(args.projectId || config.projectId || '', args.dataset || config.dataset || 'production', args.document);
                        return result;
                    }
                    catch (error) {
...
//# sourceMappingURL=actionsTools.js.map